namespace Final {
	partial class frmExplorador {
		...
		private void InitializeComponent() {
			...
			System.Windows.Forms.TreeNode treeNode4 = new System.Windows.Forms.TreeNode("Autores");
			System.Windows.Forms.TreeNode treeNode5 = new System.Windows.Forms.TreeNode("Juegos");
			System.Windows.Forms.TreeNode treeNode6 = new System.Windows.Forms.TreeNode("Adversarios");
			...
			treeNode4.Tag = "A";
			treeNode4.Text = "Autores";
			treeNode5.ImageIndex = 1;
			treeNode5.Name = "Nodo1";
			treeNode5.SelectedImageKey = "pla.png";
			treeNode5.Tag = "J";
			treeNode5.Text = "Juegos";
			treeNode6.ImageIndex = 2;
			treeNode6.Name = "Nodo0";
			treeNode6.SelectedImageKey = "adv.jpg";
			treeNode6.Tag = "Ad";
			treeNode6.Text = "Adversarios";
			...
			this.ilArbol.Images.SetKeyName(6, "resumen.png");
			// 
			// ilIcon
			// 
			...
			this.ilIcon.Images.SetKeyName(6, "resumen.png");
			// 
			// lvVista
			// 
			...
			this.ilImagenes.Images.SetKeyName(6, "resumen.png");
			// 
			// pnlDetalles
			// 
